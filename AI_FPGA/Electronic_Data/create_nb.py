...
cells = [
    ...
    },
    {
        ...
        'source': [
            ...
            '    print(f"Phục hồi từ checkpoint cũ...")\n',
            '    model = YOLO(last_checkpoint)\n',
            '    results = model.train(resume=True)\n',
            'else:\n',
            '    print("Bắt đầu huấn luyện mới với YOLOv11s...")\n',
            '    model = YOLO(' + chr(39) + 'yolo11s.pt' + chr(39) + ') # Sử dụng bản Small (s) nặng hơn bản (n)!\n',
            '    results = model.train(\n',
            '        data=' + chr(39) + '/content/dataset/electronic_components/data.yaml' + chr(39) + ',\n',
            '        epochs=100,\n',
            '        imgsz=416,           # Giữ nguyên 416x416 để tránh tràn BSRAM trên FPGA\n',
            '        batch=32,            # Giảm batch vì mô hình s nặng hơn\n',
            '        workers=8,\n',
            '        amp=True,\n',
            '        save=True,\n',
            '        project=project_dir,\n',
    ...
    },
    {
        ...
        'source': [
            ...
            'print("Hãy tải file .tflite về máy, dùng goai_c.exe để biên dịch sang yolo_electronic.h nhé!")\n'
        ]
    }
]
