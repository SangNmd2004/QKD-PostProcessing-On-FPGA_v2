...
**Định hướng xuất bản: Tạp chí Q1 (IEEE TCAS-I, IEEE TVLSI, IEEE Systems Journal)**
...
## 5. LỘ TRÌNH THỰC HIỆN BÀI BÁO Q1
...
*   **Giai đoạn 3 (Đo lường & Benchmarking):** Chạy thực nghiệm, thu thập số liệu Tài nguyên (Resource), Độ trễ (Timing), và đặc biệt là Năng lượng tiêu thụ (Power Report) để lập bảng đối chiếu trực diện, làm bằng chứng khoa học cốt lõi cho bài báo Q1.
